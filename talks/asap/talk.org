...
training. IveAs you can see, the results aren't so great right now. I'm
still working on adjusting my model parameters to get better results.

But so far, the preliminary responses do suggest a certain repetition
of language that bears out the plausibility that drives text
generation.
...
And if so, What might far-right investments in normativity illuminate
about trans investments in normativity? What might we learn about the
generative and creative effects of contagion? What might they suggest
about the allure, the seduction, of gender transgression?

As Trans Studies scholar Cassius Adair puts it, "Why shouldn't
...
skewed, that we need new ways of reading about old oppressions.
